...
show_menu(){
    ...
    echo -e "${MENU}**${NUMBER} 10)${MENU} Installation de Wordpress étape 5 (Vous êtes arrivée a la fin !)${NORMAL}"
    echo -e "${MENU}*********************************************${NORMAL}"
...
while [ opt != '' ]
  do
        ...
        sudo apt-get install php7.0; option_picked "PHP 7 est installer"; show_menu;
        menu;
        ...
        2) clear;
            ...
            sudo apt-get install apache2;  option_picked "Apache2 est installer"; show_menu;
        menu;
            ;;

        3) clear;
            option_picked "PHP 7 MY SQL est en cours d'installation ...";
        sudo apt-get install php7.0-mysql; option_picked "PHP 7 MY SQL est installer"; show_menu;
        menu;
            ;;

        4) clear;
            option_picked "libapache2-mod-php7.0 est en cours d'installation ...";
        sudo apt-get install libapache2-mod-php7.0; option_picked "libapache2-mod-php7.0 est installer"; show_menu;
        menu;
            ;;
